    ...
    <form class="space-y-6" @submit.prevent="submit">
        ...
        <div>
            ...
            <div class="mt-2 flex gap-3">
                <label v-for="a in [{ v: 'all', l: 'All' }, { v: 'alumni', l: 'Alumni' }, { v: 'students', l: 'Students' }]" :key="a.v"
                    :class="['cursor-pointer rounded-lg border px-3 py-1.5 text-sm font-medium transition', form.target_audience === a.v ? 'border-indigo-600 bg-indigo-50 text-indigo-700' : 'border-gray-300 text-gray-700']">
        ...
        <div>
                    ...
                    <div class="flex items-start gap-3">
                        <div class="flex-1 space-y-3">
                            ...
                            <div v-if="q.type !== 'text' && !hasResponses" class="space-y-1">
                                ...
                                <button type="button" class="text-xs text-indigo-600 hover:text-indigo-700" @click="addOption(q)">+ Add option</button>
            ...
            <button v-if="!hasResponses" type="button"
                class="mt-3 rounded-lg border border-dashed border-gray-300 px-4 py-2 text-sm text-gray-600 hover:border-indigo-500 hover:text-indigo-600"
                @click="addQuestion">
                + Add question
            </button>
