...
<template>
    ...
    >
        <div
            class="h-28 w-full bg-gradient-to-r from-indigo-500 via-indigo-600 to-purple-600"
        ...
        <div class="flex flex-1 flex-col p-5">
            ...
            <span
                ...
                :class="group.is_member ? 'bg-green-50 text-green-700' : 'bg-indigo-600 text-white'"
            >
