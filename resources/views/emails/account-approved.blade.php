...
<head>
    ...
    <style>
        ...
        .btn { display: inline-block; background: #8b1627; color: #ffffff; font-size: 15px; font-weight: 600; padding: 12px 28px; border-radius: 8px; text-decoration: none; margin: 8px 0 24px; }
    ...
    <div class="wrapper">
        <div class="card">
            ...
            <p style="margin:0; font-size:14px; color:#6b7280;">
                ...
                <a href="mailto:{{ config('almaconnect.contact_email') }}" style="color:#8b1627;">{{ config('almaconnect.contact_email') }}</a>.
            </p>
        </div>
